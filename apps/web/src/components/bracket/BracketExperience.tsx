  ...
  return (
    <>
      ...
      <div className="space-y-6">
        <section className="overflow-hidden rounded-lg border border-border bg-card shadow-[0_24px_80px_rgba(0,0,0,0.28)]">
          <div className="grid gap-4 border-b border-border bg-[linear-gradient(135deg,rgba(57,255,136,0.12),rgba(110,168,255,0.06)_38%,rgba(8,12,19,0)_70%)] p-5 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
...
function BracketWall({
  ...
  return (
    <section className="rounded-lg border border-border bg-[#05080b] p-3 shadow-[0_24px_80px_rgba(0,0,0,0.28)] sm:p-4">
  ...
  return (
    <div
      className={`mt-2 grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 rounded-md px-2.5 py-2 ${
        winner && revealed ? "bg-primary text-zinc-950" : "bg-muted/40"
      }`}
    >
...
function MatchDetailDrawer({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/70 p-4 sm:items-center">
      <div className="max-h-[85vh] w-full max-w-lg overflow-y-auto rounded-lg border border-border bg-card p-5 shadow-[0_24px_80px_rgba(0,0,0,0.45)]">
